...
CREATE TABLE estabelecimentos (
                                  ...
                                  data_situacao_cadastral      TIMESTAMP WITHOUT TIME ZONE,
                                  motivo_situacao_cadastral_id BIGINT,
                                  nome_cidade_exterior         VARCHAR(60),
                                  pais_id                      BIGINT,
                                  data_inicio_atividade        TIMESTAMP WITHOUT TIME ZONE,
                                  ...
                                  data_situacao_especial       TIMESTAMP WITHOUT TIME ZONE,
...
CREATE TABLE simples (
                         ...
                         data_opcao_simples    TIMESTAMP WITHOUT TIME ZONE,
                         data_exclusao_simples TIMESTAMP WITHOUT TIME ZONE,
                         opcao_pelo_mei        VARCHAR(10),
                         data_opcao_mei        TIMESTAMP WITHOUT TIME ZONE,
                         data_exclusao_mei     TIMESTAMP WITHOUT TIME ZONE,
...
CREATE TABLE socios (
                        ...
                        data_entrada_sociedade              TIMESTAMP WITHOUT TIME ZONE,
                        pais_id                             BIGINT,
